...
ResourceNodeData.Nodes = {
    ...
    },
    {
        id = "gold_2",
        type = "Gold",
        position = Vector3.new(400, 0, 150),
        amount = { min = 200, max = 500 },
        respawnTime = RESPAWN_GOLD,
    },
    {
        id = "gold_3",
        type = "Gold",
        position = Vector3.new(650, 0, 200),
        amount = { min = 200, max = 500 },
        respawnTime = RESPAWN_GOLD,
    },
    {
        id = "gold_4",
        type = "Gold",
        position = Vector3.new(800, 0, 500),
        amount = { min = 200, max = 500 },
        respawnTime = RESPAWN_GOLD,
    },
    {
        id = "gold_5",
        type = "Gold",
        position = Vector3.new(350, 0, 800),
        amount = { min = 200, max = 500 },
        respawnTime = RESPAWN_GOLD,
    },
    {
        id = "gold_6",
        type = "Gold",
        position = Vector3.new(550, 0, 650),
        amount = { min = 200, max = 500 },
        respawnTime = RESPAWN_GOLD,
    },
    ...
    -- ═══════════════════════════════════════════════════════════════════════════
    {
        id = "wood_1",
        type = "Wood",
        position = Vector3.new(250, 0, 600),
    ...
    },
    {
        id = "wood_2",
        type = "Wood",
        position = Vector3.new(500, 0, 400),
        amount = { min = 150, max = 400 },
        respawnTime = RESPAWN_WOOD,
    },
    {
        id = "wood_3",
        type = "Wood",
        position = Vector3.new(750, 0, 350),
        amount = { min = 150, max = 400 },
        respawnTime = RESPAWN_WOOD,
    },
    {
    ...
    },
    {
        id = "wood_5",
        type = "Wood",
        position = Vector3.new(450, 0, 850),
        amount = { min = 150, max = 400 },
        respawnTime = RESPAWN_WOOD,
    },
    {
        id = "wood_6",
        type = "Wood",
        position = Vector3.new(850, 0, 700),
        amount = { min = 150, max = 400 },
        respawnTime = RESPAWN_WOOD,
    },
    ...
    -- ═══════════════════════════════════════════════════════════════════════════
    {
        id = "food_1",
        type = "Food",
        position = Vector3.new(700, 0, 350),
    ...
    },
    {
        id = "food_2",
        type = "Food",
        position = Vector3.new(300, 0, 450),
        amount = { min = 100, max = 300 },
        respawnTime = RESPAWN_FOOD,
    },
    {
        id = "food_3",
        type = "Food",
        position = Vector3.new(550, 0, 300),
        amount = { min = 100, max = 300 },
        respawnTime = RESPAWN_FOOD,
    },
    {
        id = "food_4",
        type = "Food",
        position = Vector3.new(150, 0, 750),
        amount = { min = 100, max = 300 },
        respawnTime = RESPAWN_FOOD,
    },
    {
        id = "food_5",
        type = "Food",
        position = Vector3.new(800, 0, 850),
        amount = { min = 100, max = 300 },
        respawnTime = RESPAWN_FOOD,
    },
    {
        id = "food_6",
        type = "Food",
        position = Vector3.new(650, 0, 550),
        amount = { min = 100, max = 300 },
        respawnTime = RESPAWN_FOOD,
    },
}
